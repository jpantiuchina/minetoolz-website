...
<head>
  ...
  <link href="images/faviconimage.ico" rel="shortcut icon"/>
    ...
    <div id="page">
      ...
      <div id="dotted">
        ...
        <div id="second-tool">
          <div id="page-3">
            <div id="dotted-tool">
              <img src="images/seven-plus.jpg" alt="seven-plus" width="52px" height="52px" id="image-seven-plus"/>
            </div>
            <div id="para-2">
              <div id="text-2-1">
        ...
        <div id="final-tool">
          <div id="page-4">
            <div id="dotted-tool-2">
              <img src="images/seven-plus.jpg" alt="seven-plus" width="52px" height="52px" id="image-seven-plus-2"/>
            </div>
            <div id="para-3">
              <div id="text-3-1">
          ...
          <div id="page-5">
            <div class="block-1">
              <div class="rotating-dashed">
                ...
                <div class="more-text">Tools to support prototype and validation of innovation products and services</div>
              </div>
            </div>
            <div class="block-1">
              <div class="image1">
              ...
              <div class="text-header"></div>
              <div class="more-text">Tools to support teamwork of highly dynamic and motivated entrepreneur</div>
            </div>
            <div style="clear:both"></div>
            <div class="block-1">
              <div class="image1">
          ...
          <div id="button">
            <div id="facebook-button">
              <a href="https://www.facebook.com/mine.toolz" target="_blank">
                <img src="images/facebook.png" width="20px" height="20px" alt="facebook" id="image-facebook"/>
              </a>
            </div>
            <div id="twitter-button">
              <a href="https://twitter.com/minetoolz" target="_blank">
                <img src="images/twitter.png" width="20px" height="20px" alt="facebook" id="image-twitter"/>
              </a>
            </div>
          </div>
        </div>
